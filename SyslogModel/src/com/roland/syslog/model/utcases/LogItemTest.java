...
public class LogItemTest {
	...
	public void testSyslogFileReader() {
		...
		LinkedList<LogItem> items = container.getLogItemList();
		assertTrue(items.size() == 12);

		LinkedList<LogItemData> results = initTestSyslogFileReader();
	...
	private LinkedList<LogItemData> initTestSyslogFileReader() {
